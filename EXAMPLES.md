...
- [ ] Approach explanation saves
- [ ] Code editor syntax highlights
- [ ] AI provides feedback within 5 seconds
- [ ] Feedback includes technical + communication aspects
- [ ] Follow-up questions are relevant
- [ ] Session summary generates
- [ ] Chat messages flow naturally
- [ ] Error handling works (empty code, network issues)
...
- **Code submissions per session**: 1-3
...
**Pro Tip:** Have 2-3 problems ready to demo. Show one where you communicate well, one where you don't, to demonstrate the AI's feedback quality.
